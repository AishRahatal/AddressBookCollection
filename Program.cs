            ...
            while (choice != 0)
            {
                ...
                switch (choice)
                {
                    case 1:
                        ...
                        break;
                    case 2: Console.WriteLine("Address Book:");
                        Console.WriteLine("-----------------------------------------------------");
                        obj.ListPeople();
                        Console.WriteLine("-----------------------------------------------------");

                        break;
                    case 3:Console.WriteLine("Remove Contact:");
                        Console.WriteLine("-----------------------------------------------------");
                    ...
                    case 5:
                        ...
                        break;
                    case 6: Console.WriteLine("View contacts by state :");
                        Console.WriteLine("-----------------------------------------------------");
                    ...
                    case 7:
                        ...
                        break;
                    case 8: Console.WriteLine("View count of contacts by state :");
                        Console.WriteLine("-----------------------------------------------------");
                    ...
                    case 9: Console.WriteLine("View contacts by city :");
                        Console.WriteLine("-----------------------------------------------------");
